...
<div className="container" style={{ overflowX: 'hidden' }}>
  <div className="row about-top" style={{ marginTop: "150px", marginBottom: "100px" }}>
    
    {/* LEFT COLUMN */}
    <div className="col-lg-6 col-md-6 col-12 about" data-aos="fade-right">
      <div style={{ paddingRight: '5px' }}>
        ...
        <div className="d-flex flex-wrap mt-4 gap-4" id="about-uae">
    ...
    {/* RIGHT COLUMN */}
    <div className="col-lg-6 col-md-6 col-12 d-flex justify-content-center about-img" data-aos="fade-left">
      <div style={{
        width: "100%",
        maxWidth: "450px",
        border: '1px solid #003C82',
