          ...
          <div className="container">
            ...
            <h2 style={{fontSize:'40px',fontWeight:'700',marginTop:'150px',marginBottom:'50px'}}>High-Performance Fuel Solutions</h2>
              ...
              <div className="row">
                  ...
                  <div className="col-lg-4" style={{border:'1px solid #003C82',padding:'15px',borderRadius:'25px',marginRight:'20px'}}>
                      <div style={{display:'flex',justifyContent:'space-evenly',alignItems:'center'}}>
                        <p style={{fontSize:'30px',fontWeight:'600',textAlign:'start'}}>Enhanced Combustion</p>
                  ...
                  <div className="col-lg-4"  style={{border:'1px solid #003C82',padding:'15px',borderRadius:'25px',marginRight:'20px'}}>
                      ...
                      <div style={{display:'flex',justifyContent:'space-evenly',alignItems:'center'}}>
                        <p style={{fontSize:'30px',fontWeight:'600',textAlign:'start'}}>Eco-Friendly Options</p>
              ...
              <div className="row" style={{marginTop:'50px'}}>
                  ...
                  <div className="col-lg-4" style={{border:'1px solid #003C82',padding:'15px',borderRadius:'25px',marginRight:'20px'}}>
                      <div style={{display:'flex',justifyContent:'space-evenly',alignItems:'center'}}>
                        <p style={{fontSize:'30px',fontWeight:'600',textAlign:'start'}}>Superior Performance</p>
                  ...
                  <div className="col-lg-4"  style={{border:'1px solid #003C82',padding:'15px',borderRadius:'25px',marginRight:'20px'}}>
                      ...
                      <div style={{display:'flex',justifyContent:'space-evenly',alignItems:'center'}}>
                        <p style={{fontSize:'30px',fontWeight:'600',textAlign:'start'}}>Engine Protection</p>
          ...
          <div className="container">
            ...
            <h2 style={{fontSize:'40px',fontWeight:'700',marginTop:'150px',marginBottom:'50px'}}>Safe Handling & Storage Systems</h2>
              ...
              <div className="row">
                  ...
                  <div className="col-lg-8" style={{ border: '1px solid #003C82', padding: '15px', borderRadius: '25px' }}>
                      
                      <div style={{display:'flex'}}>
                          
                          <div style={{width:'70%'}}>
                          <p style={{ fontSize: '30px', fontWeight: '600', marginTop:'20px',textAlign:'start' }}>1. Advance Safety Protocol</p>
              ...
              <div className="row mt-5">
                  ...
                  <div className="col-lg-8" style={{ border: '1px solid #003C82', padding: '15px', borderRadius: '25px' }}>
                      ...
                      <div style={{display:'flex'}}>
                          ...
                          <div style={{width:'70%'}}>
                          <p style={{ fontSize: '30px', fontWeight: '600', marginTop:'20px',textAlign:'start' }}>2. Modern Storage Facilities</p>
              ...
              <div className="row mt-5">
                  ...
                  <div className="col-lg-8" style={{ border: '1px solid #003C82', padding: '15px', borderRadius: '25px' }}>
                      ...
                      <div style={{display:'flex'}}>
                          ...
                          <div style={{width:'70%'}}>
                          <p style={{ fontSize: '30px', fontWeight: '600', marginTop:'20px',textAlign:'start',padding:'0 30px' }}>3. Quality Monitoring</p>
              ...
              <div className="row mt-5">
                  ...
                  <div className="col-lg-8" style={{ border: '1px solid #003C82', padding: '15px', borderRadius: '25px' }}>
                      ...
                      <div style={{ display: 'flex' }}>
                          ...
                          <div style={{width:'70%'}}>
                          <p style={{ fontSize: '30px', fontWeight: '600', marginTop:'20px',textAlign:'start',padding:'0 30px' }}>4. Environmental Compliance</p>
